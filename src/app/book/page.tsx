...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Book a Call', item: `${SITE_URL}/book` },
  ],
}
          ...
          <div className="flex flex-col gap-10">
            <div>
              ...
              <p className="text-fg-muted text-lg leading-relaxed">
                ...
                what you need to scale. I&apos;ll come with questions. If we&apos;re a
                good fit, I&apos;ll send a written scope within 48 hours.
              </p>
            </div>
            ...
            <div className="card-surface rounded-xl px-6 py-5">
              ...
              <p className="text-fg-muted mb-3 text-sm leading-relaxed">
                Skip the call — send a written brief and I&apos;ll respond within 24
                hours.
              </p>
              <Link
                href="/contact"
